...
class API:
    def __init__(self, game_state_proto):
        self.game_state = game_state_proto
    ...
    def findEnemiesByDistance(self, pos, player_name):
        """
    ...
    def findItemsInRangeByDistance(self, pos, player_name, range):
        """
        ...
        """
        if isinstance(pos, position.Position) and isinstance(player_name, str) and isinstance(range, int):
    ...
    def findEnemiesInRangeOfAttackByDistance(self, pos, player_name):
        """
    ...
    def findAllEnemiesHit(self, pos, player_name):
        """
    ...
    def inRangeOfAttack(self, pos, player_name):
        """
    ...
    def findClosestPortal(self, pos):
        """
